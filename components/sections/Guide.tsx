  ...
  return (
    <Section id={guide.id} tone="pearl">
      ...
      <div className="relative z-10 mx-auto max-w-7xl px-5 sm:px-6 md:px-8">
        <SectionHeading title={`${guide.title} — ${guide.name}`} subtitle={guide.role} />

        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 sm:gap-12 lg:gap-20 items-center max-w-5xl mx-auto">
          <FadeInView>
            <div className="relative max-w-xs sm:max-w-sm mx-auto">
              <div
                className="absolute -inset-6 rounded-sm opacity-35 blur-3xl animate-glow-pulse pointer-events-none"
                style={{
              ...
              <GoldenPortraitFrame className="glow-gold">
                <ImagePlaceholder
                  src={guide.image.src}
                  alt={guide.image.alt}
                  fill
              ...
              <p className="mt-5 sm:mt-6 text-center font-display text-lg sm:text-xl text-text-dark tracking-wide">
                {guide.name}
              </p>
            </div>
          </FadeInView>
